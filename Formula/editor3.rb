class Editor3 < Formula
  ...
  homepage "https://github.com/davidmcnamee/packaged-claude-server"
  url "https://github.com/davidmcnamee/packaged-claude-server/releases/download/v1.0.2/editor3-backend-v1.0.2.tar.gz"
